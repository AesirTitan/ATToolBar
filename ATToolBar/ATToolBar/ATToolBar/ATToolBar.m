...
- (void)_layoutButtons{
    ...
    for (int i=0; i<_titles.count; i++) {
        ...
        [btn setTitleColor:[UIColor colorWithRed:0.73 green:0.87 blue:0.98 alpha:1.00] forState:UIControlStateNormal];
        [btn setTitleColor:[UIColor colorWithRed:0.13 green:0.58 blue:0.95 alpha:1.00] forState:UIControlStateSelected];
...
- (void)_initLine{
    ...
    _line.backgroundColor = [UIColor colorWithRed:0.13 green:0.58 blue:0.95 alpha:1.00].CGColor;
